...
patch_api_wrapper_s3_env_aliases(){
  ...
  log "Patching ComfyUI API wrapper to use AWS_IMAGE_* for generated-image S3"
...
PYPATCH
  ...
  if command -v supervisorctl >/dev/null 2>&1; then
    ...
    log "WARNING: supervisorctl unavailable; api-wrapper restart skipped"
  fi
}
